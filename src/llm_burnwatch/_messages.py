"""Single point of user-facing warning/error output for llm-burnwatch.
...
``[llm-burnwatch]`` prefix consistent across the whole codebase and is enforced
